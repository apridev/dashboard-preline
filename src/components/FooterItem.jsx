...
const FooterItem = () => {
  return (
    <>
      <footer className="mt-auto w-full dark:border dark:border-t-2 dark:border-neutral-700 bg-white dark:bg-neutral-800 shadow-sm max-w-[85rem] py-2 px-4 sm:px-6 lg:px-8 mx-auto">
        {/* <!-- Grid --> */}
        <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
          <div>
            <a
              className="flex-none text-sm font-normal text-gray-500 dark:text-neutral-500"
              href="#"
              aria-label="Brand"
            >
              Copyright © 2024 Aprianto Fajar
            </a>
          </div>
          {/* <!-- End Col --> */}
